...
var burgerBody = document.querySelector(".menu__body")
...
document.addEventListener("click", function (e) {
	const targetElement = e.target;
	if (!targetElement.closest('.subscribe__button') && !targetElement.closest('.input')) {
		input.value = "";
		input.style.color = '#828282';
	}
})
...
// third slider
if (document.querySelector('.slider-tips__boby')) {
	new Swiper('.slider-tips__boby', {
		observer: true,
		observeParents: true,
		slidesPerView: 3,
		spaceBetween: 32,
